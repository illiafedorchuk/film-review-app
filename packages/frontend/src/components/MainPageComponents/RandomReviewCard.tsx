...
const RandomReviewCard: React.FC<RandomReviewCardProps> = ({ reviews }) => {
  ...
  return (
    <>
      <div className="ml-10  w-[280px]  rounded-lg bg-[var(--link-hover-color)] relative max-lg:hidden">
        <div
          className={`duration-300 bg-[var(--button-bg-color)] rounded-lg w-full h-full flex flex-col items-center justify-center p-4 hover:shadow-[0_0_30px_3px_rgba(100,0,300,0.3)] cursor-pointer ${
        ...
        >
          {reviews.length === 0 ? (
            ...
            <>
              ...
              <p className="text-white font-bold mb-2 text-l md:text-sm">
                {currentReview.author}
              </p>
              <p className="text-white cursor-pointer mb-4 text-xs">
