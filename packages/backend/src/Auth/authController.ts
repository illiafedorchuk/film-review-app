  ...
  public async refreshToken(
    ...
    try {
      const user = await userRepository.findOne({
        ...
        select: ["id", "refreshToken"], // Make sure 'refreshToken' is a column in your User entity
      });
      ...
      const decoded = jwt.decode(newAccessToken) as JwtPayload; // Be cautious, decode can return null
